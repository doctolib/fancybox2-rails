...
Gem::Specification.new do |s|
  ...
  s.summary     = "Use FancyBox 2 with Rails 4.2/5"
  s.description = "This gem provides jQuery FancyBox 2 for your Rails 4.2/5 application. This gem is based on the gem for Fancybox 1.x by Chris Mytton"
